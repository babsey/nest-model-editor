...
/* harmony default export */ __webpack_exports__["default"] = ("<app-model></app-model>\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<span class=\"form-group\">\n  <button type=\"button\" mat-stroked-button (click)=\"fileInput.click()\">Choose File</button>\n  <input #fileInput hidden type=\"file\" id=\"file\" (change)=\"handleFileInput($event)\">\n</span>\n\n<ng-container *ngIf=\"data.neuron\">\n  <span style=\"display:flex;width:100%\">\n\n    <div style=\"width:50%;margin:8px\">\n      <form>\n        <mat-form-field>\n          <input matInput placeholder=\"Neuron\" [(ngModel)]=\"data.neuron\" [ngModelOptions]=\"{standalone: true}\">\n        </mat-form-field>\n\n        <ng-container *ngFor=\"let block of blocks\">\n          <mat-form-field>\n            <textarea matInput placeholder=\"{{ block }}\" cdkTextareaAutosize [(ngModel)]=\"data[block]\" [ngModelOptions]=\"{standalone: true}\"></textarea>\n          </mat-form-field>\n        </ng-container>\n\n        <span class=\"button-row\">\n          <button mat-stroked-button (click)=\"onSubmit()\">Generate</button>\n          <button mat-stroked-button (click)=\"reset()\">Reset</button>\n        </span>\n      </form>\n    </div>\n\n    <!-- <div style=\"width:50%;margin:8px\">\n  {{ data | json }}\n  </div> -->\n\n  </span>\n</ng-container>\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("mat-form-field {\n  width: 100%;\n}\n\n.button-row button,\n.button-row a {\n  margin-left: 8px;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */");
...
var ModelComponent = /** @class */ (function () {
    function ModelComponent(_modelService) {
        this._modelService = _modelService;
        this.blocks = ['state', 'initial_values', 'equations', 'parameters', 'internals', 'input', 'output', 'update'];
        this.data = {};
    }
    ...
    ModelComponent.prototype.handleFileInput = function (event) {
        var _this = this;
        var selectedFile = event.target.files[0];
        var fileReader = new FileReader();
        fileReader.readAsText(selectedFile, "UTF-8");
        fileReader.onloadend = function () {
            _this.data = JSON.parse(fileReader.result);
    ...
    ], ModelComponent.prototype, "fileInput", void 0);
    ModelComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-model',
            template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./model.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/model/model.component.html")).default,
            styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./model.component.css */ "./src/app/model/model.component.css")).default]
        }),
...
/* harmony import */ var _model_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./model.component */ "./src/app/model/model.component.ts");
...
var ModelModule = /** @class */ (function () {
    ...
    ModelModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [_model_component__WEBPACK_IMPORTED_MODULE_4__["ModelComponent"]],
            exports: [
...
var ModelService = /** @class */ (function () {
    ...
    ModelService.prototype.install = function (data) {
        var urlRoot = 'http://localhost:5000';
        this.http.post(urlRoot + '/script/model/install', data).subscribe(function (res) {
            console.log('res', res);
        }, function (error) {
...
module.exports = __webpack_require__(/*! /home/spreizer/Projects/nest/nest-model-editor/src/main.ts */"./src/main.ts");
